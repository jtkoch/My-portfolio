...
$your_email = "jtkoch12@gmail.com"; // email address to which the form data will be sent
$subject = "Portfolio Contact Message"; // subject of the email that is sent
$thanks_page = "contact/thankyou.html"; // path to the thank you page following successful form submission
$contact_page = "contact/index.html"; // path to the HTML contact page where the form appears
